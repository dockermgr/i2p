...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/i2p"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="i2p"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/i2p"
APPDIR="$HOME/.local/share/srv/docker/i2p"
DATADIR="$HOME/.local/share/srv/docker/i2p/rootfs"
...
I2P_USERNAME="${I2P_USERNAME:-$DEFAULT_USERNAME}"
...
CONTAINER_USER_NAME="${I2P_USERNAME:-}"
CONTAINER_USER_PASS="${I2P_PASSWORD:-}"
...
CONTAINER_DOMAINNAME="${CONTAINER_DOMAINNAME:-$SERVER_SHORT_DOMAIN.$SERVER_SHORT_DOMAIN.$SERVER_FULL_DOMAIN}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Configure variables
